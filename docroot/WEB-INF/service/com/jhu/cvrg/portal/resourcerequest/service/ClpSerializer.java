...
import com.jhu.cvrg.portal.resourcerequest.model.ResourceRequestClp;
...
public class ClpSerializer {
	...
	public static Object translateInput(BaseModel<?> oldModel) {
		...
		if (oldModelClassName.equals(ResourceRequestClp.class.getName())) {
			...
			try {
				...
				try {
					Class<?> newModelClass = Class.forName("com.jhu.cvrg.portal.resourcerequest.model.impl.ResourceRequestImpl",
							true, _classLoader);
		...
		if (oldModelClassName.equals(TransactionClp.class.getName())) {
			...
			try {
				...
				try {
					Class<?> newModelClass = Class.forName("com.jhu.cvrg.portal.resourcerequest.model.impl.TransactionImpl",
							true, _classLoader);
	...
	public static Object translateOutput(BaseModel<?> oldModel) {
		...
		if (oldModelClassName.equals(
					"com.jhu.cvrg.portal.resourcerequest.model.impl.ResourceRequestImpl")) {
			ClassLoader contextClassLoader = Thread.currentThread()
												   .getContextClassLoader();
		...
		if (oldModelClassName.equals(
					"com.jhu.cvrg.portal.resourcerequest.model.impl.TransactionImpl")) {
			ClassLoader contextClassLoader = Thread.currentThread()
												   .getContextClassLoader();
